...
from player_attachments import Atachment
...
class Player:
    def __init__(self, screen: pygame.Surface, origin: tuple[float, float], spawn: tuple[float, float]) -> None:
        ...
        self.weapon_slots: dict[int, Optional[Atachment]] = {}
    ...
    def draw_attachment_nodes(self, dragging_weapon: Optional[Atachment] = None) -> None:
        """
